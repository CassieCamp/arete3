      ...
      <div className="flex items-center justify-center min-h-screen">
        <Card className="w-96">
          <CardHeader>
            ...
            <CardDescription>Please sign in to access your practice.</CardDescription>
          </CardHeader>
        </Card>
      </div>
    );
                ...
                <CardContent className="p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-semibold text-foreground">{dashboardData.active_clients}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-semibold text-foreground">{dashboardData.pending_clients}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
